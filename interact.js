/**
 added npm interact.js
 added js for elements in index.js
 */
(function (f) {
  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          var InteractEvent = (function () {
            ...
            function InteractEvent(
              ...
              var deltaSource = ((target && target.options) || defaults)
                .deltaSource;
              ...
              this.t0 = starting
                ? interaction.downTimes[interaction.downTimes.length - 1]
                : prevEvent.t0;
              ...
              this.swipe =
                ending || phase === "inertiastart" ? this.getSwipe() : null;
            ...
            InteractEvent.prototype.preventDefault =
            ...
            InteractEvent.prototype.stopPropagation =
        ...
        function (require, module, exports) {
          ...
          var Interactable = (function () {
            ...
            function Interactable(target, options) {
              ...
              this._win = getWindow(
                trySelector(target) ? this._context : target
              );
            ...
            Interactable.prototype.setOnEvents = function setOnEvents(
              action,
              phases
            ) {
            ...
            Interactable.prototype.setPerAction = function setPerAction(
              action,
              options
            ) {
            ...
            Interactable.prototype._backCompatOption =
              function _backCompatOption(optionName, newValue) {
            ...
            Interactable.prototype.deltaSource = function deltaSource(
              newValue
            ) {
            ...
            Interactable.prototype._onOffMultiple = function _onOffMultiple(
              method,
              eventType,
              listener,
              options
            ...
            Interactable.prototype.on = function on(
              eventType,
              listener,
              options
            ) {
            ...
            Interactable.prototype.off = function off(
              eventType,
              listener,
              options
            ) {
            ...
            Interactable.prototype.set = function set(options) {
              ...
              for (
                var _i3 = 0;
                _i3 < Interactable.settingsMethods.length;
                _i3++
              ) {
                var _ref3;
          ...
          scope.interactables.indexOfElement = function indexOfElement(
            target,
            context
          ) {
          ...
          scope.interactables.get = function interactableGet(
            element,
            options,
            dontCheckInContext
          ) {
            var ret =
              this[this.indexOfElement(element, options && options.context)];

            return ret &&
              (is.string(element) ||
                dontCheckInContext ||
                ret.inContext(element))
              ? ret
              : null;
          };
              ...
              if (
                (is.string(interactable.target)
                  ? // target is a selector and the element matches
                    is.element(element) &&
                    matchesSelector(element, interactable.target)
      ...
      5: [
        function (require, module, exports) {
          ...
          var Interaction = (function () {
            ...
            Interaction.prototype.pointerMove = function pointerMove(
              pointer,
              event,
              eventTarget
            ) {
              ...
              if (this.pointerIsDown && !this.pointerWasMoved) {
                ...
                this.pointerWasMoved =
                  utils.hypot(dx, dy) > Interaction.pointerMoveTolerance;
              }
            ...
            Interaction.prototype.pointerUp = function pointerUp(
              pointer,
              event,
              eventTarget,
              curEventTarget
            ...
            Interaction.prototype.getPointerIndex = function getPointerIndex(
              pointer
            ) {
            ...
            Interaction.prototype.updatePointer = function updatePointer(
              pointer,
              event
            ) {
              var down =
                arguments.length > 2 && arguments[2] !== undefined
                  ? arguments[2]
                  : event && /(down|start)$/i.test(event.type);
            ...
            Interaction.prototype.removePointer = function removePointer(
              pointer,
              event
            ) {
              var index = this.getPointerIndex(pointer);
            ...
            Interaction.prototype._updateEventTargets =
              function _updateEventTargets(target, currentTarget) {
              ...
              if (browser.supportsTouch && /touch/.test(event.type)) {
                ...
                for (var _i2 = 0; _i2 < event.changedTouches.length; _i2++) {
                  ...
                  matches.push([
                    pointer,
                    interaction ||
                      new Interaction({ pointerType: pointerType }),
                  ]);
                }
              } else {
                ...
                if (!browser.supportsPointerEvent && /mouse/.test(event.type)) {
                  ...
                  for (
                    var i = 0;
                    i < scope.interactions.length && !invalidPointer;
                    i++
                  ) {
                    invalidPointer =
                      scope.interactions[i].pointerType !== "mouse" &&
                      scope.interactions[i].pointerIsDown;
                  }
                ...
                if (!invalidPointer) {
                  var _interaction = finder.search(
                    event,
                    event.type,
                    eventTarget
                  );
          ...
          function onDocSignal(_ref5, signalName) {
            ...
            var eventMethod =
              signalName.indexOf("add") === 0 ? events.add : events.remove;
          ...
          signals.on("update-pointer-down", function (_ref6) {
            ...
            if (!interaction.interacting()) {
              ...
              interaction.downTimes[pointerIndex] =
                interaction.curCoords.timeStamp;
              interaction.downTargets[pointerIndex] =
                eventTarget || (event && utils.getEventTargets(event)[0]);
      ...
      6: [
        function (require, module, exports) {
          ...
          function firePrepared(interaction, event, phase, preEnd) {
            ...
            var newEvent = new InteractEvent(
              interaction,
              event,
              actionName,
              phase,
        ...
        function (require, module, exports) {
          ...
          Interaction.signals.on("before-action-move", function (_ref) {
            ...
            if (axis === "x") {
              ...
              interaction.pointerDelta.page.speed = Math.abs(
                interaction.pointerDelta.page.vx
              );
              interaction.pointerDelta.client.speed = Math.abs(
                interaction.pointerDelta.client.vx
              );
              ...
              interaction.pointerDelta.page.speed = Math.abs(
                interaction.pointerDelta.page.vy
              );
              interaction.pointerDelta.client.speed = Math.abs(
                interaction.pointerDelta.client.vy
              );
      ...
      8: [
        function (require, module, exports) {
          ...
          InteractEvent.signals.on("new", function (_ref2) {
            ...
            interaction.dropEvents = getDropEvents(
              interaction,
              event,
              dragEvent
            );
          ...
          function collectDrops(activeDrops, element) {
            ...
            for (var _i = 0; _i < scope.interactables.length; _i++) {
              ...
              if (
                (utils.is.element(accept) && accept !== element) ||
              ...
              var dropElements = utils.is.string(current.target)
          ...
          function setActiveDrops(activeDrops, dragElement) {
            ...
            for (var i = 0; i < activeDrops.dropzones.length; i++) {
              activeDrops.rects[i] = activeDrops.dropzones[i].getRect(
                activeDrops.elements[i]
              );
            }
          }
            ...
            if (interaction.dropElement !== interaction.prevDropElement) {
              ...
              if (interaction.prevDropTarget) {
                ...
                dragEvent.dragLeave = dropEvents.leave.target =
                  interaction.prevDropElement;
                dragEvent.prevDropzone = dropEvents.leave.dropzone =
                  interaction.prevDropTarget;
              }
          ...
          Interactable.prototype.dropCheck = function (
            ...
            if (dragRect && utils.is.number(dropOverlap)) {
              ...
              var overlapRatio =
                overlapArea / (dragRect.width * dragRect.height);
      ...
      9: [
        function (require, module, exports) {
          ...
          InteractEvent.signals.on("new", function (_ref) {
            ...
            interaction.gesture.startDistance =
              interaction.gesture.prevDistance = iEvent.distance;
            interaction.gesture.startAngle = interaction.gesture.prevAngle =
              iEvent.angle;
          ...
          InteractEvent.signals.on("set-delta", function (_ref3) {
            ...
            if (starting) {
              ...
              iEvent.box = utils.touchBBox(pointers);
              iEvent.scale =
                iEvent.distance / interaction.gesture.startDistance;
              iEvent.angle = utils.touchAngle(
                pointers,
        ...
        function (require, module, exports) {
              ...
              if (options.resize.enabled) {
                ...
                if (utils.is.object(resizeOptions.edges)) {
                  ...
                  var right =
                    ...
                    page.x > rect.right - defaultMargin;
                  var bottom =
                    options.resize.axis !== "x" &&
                    page.y > rect.bottom - defaultMargin;
          ...
          function checkResizeEdge(
            ...
            if (value === true) {
              ...
              var width = utils.is.number(rect.width)
                ? rect.width
                : rect.right - rect.left;
              var height = utils.is.number(rect.height)
                ? rect.height
            ...
            onInteractionMove: function onInteractionMove(_ref) {
              ...
              var options =
                interaction.target.options[interaction.prepared.name]
                  .autoScroll;
              var container =
                options.container || getWindow(interaction.element);
      ...
      12: [
        function (require, module, exports) {
          ...
          Interactable.prototype.getAction = function (
            pointer,
            event,
            interaction,
            element
          ...
          Interactable.prototype.testIgnore = function (
            ignoreFrom,
            interactableElement,
            element
          ) {
          ...
          Interactable.prototype.testAllow = function (
            allowFrom,
            interactableElement,
            element
          ) {
          ...
          Interactable.prototype.testIgnoreAllow = function (
            options,
            interactableElement,
            eventTarget
          ) {
        ...
        function (require, module, exports) {
          ...
          Interaction.signals.on("move", function (arg) {
            ...
            if (interaction.prepared.name && target) {
              ...
              if (
                target.options[interaction.prepared.name].manualStart ||
          ...
          function getActionInfo(interaction, pointer, event, eventTarget) {
            ...
            while (utils.is.element(element)) {
              ...
              var actionInfo = validateSelector(
                interaction,
                pointer,
                event,
                matches,
        ...
        function (require, module, exports) {
            ...
            if (status.active) {
              ...
              while (utils.is.element(element)) {
                ...
                if (element === interaction.element) {
                  ...
                  // fire a reume event
                  var resumeEvent = new InteractEvent(
                    interaction,
                    event,
                    interaction.prepared.name,
                    "inertiaresume",
          ...
          Interaction.signals.on("up", function (_ref2) {
            ...
            var inertiaOptions =
              options &&
              interaction.prepared.name &&
              options[interaction.prepared.name].inertia;
            ...
            interaction.pointers[0] = status.startEvent = new InteractEvent(
              interaction,
              event,
              interaction.prepared.name,
              "inertiastart",
            ...
            if (inertia) {
              ...
              status.i = animationFrame.request(
                interaction.boundSmoothEndFrame
              );
            }
          });
          ...
          function calcInertia(interaction, status) {
            ...
            var inertiaDur =
              -Math.log(inertiaOptions.endSpeed / status.v0) / lambda;
          ...
          function inertiaFrame() {
            ...
            if (t < status.te) {
              var progress =
                1 -
                (Math.exp(-lambda * t) - status.lambda_v0) / status.one_ve_v0;

              if (
                status.modifiedXe === status.xe &&
                status.modifiedYe === status.ye
              ) {
          ...
          function smoothEndFrame() {
            ...
            var duration =
              this.target.options[this.prepared.name].inertia.smoothEndDuration;
      ...
      21: [
        function (require, module, exports) {
          ...
          interact.isSet = function (element, options) {
            return (
              scope.interactables.indexOfElement(
                element,
     ...
     */
          ...
          var modifiers = {
            ...
            setOffsets: function setOffsets(arg) {
              ...
              for (var _i = 0; _i < modifiers.names.length; _i++) {
                ...
                arg.options =
                  target.options[interaction.prepared.name][modifierName];
            ...
            setAll: function setAll(arg) {
              ...
              result.shouldMove =
                !arg.status || !result.locked || arg.status.changed;
        ...
        function (require, module, exports) {
          ...
          var restrict = {
            ...
            set: function set(_ref2) {
              ...
              if ("x" in restriction && "y" in restriction) {
                modifiedX = Math.max(
                  Math.min(rect.x + rect.width - offset.right, page.x),
                  rect.x + offset.left
                );
                modifiedY = Math.max(
                  Math.min(rect.y + rect.height - offset.bottom, page.y),
                  rect.y + offset.top
                );
              } else {
                modifiedX = Math.max(
                  Math.min(rect.right - offset.right, page.x),
                  rect.left + offset.left
                );
                modifiedY = Math.max(
                  Math.min(rect.bottom - offset.bottom, page.y),
                  rect.top + offset.top
                );
              }
          ...
          function getRestrictionRect(value, interaction, page) {
            if (utils.is.function(value)) {
              return utils.resolveRectLike(
                value,
                interaction.target,
                interaction.element,
                [page.x, page.y, interaction]
              );
            } else {
              return utils.resolveRectLike(
                value,
        ...
        function (require, module, exports) {
          ...
          var restrictEdges = {
            ...
            set: function set(_ref2) {
              ...
              var edges =
                interaction.prepared.linkedEdges || interaction.prepared.edges;
              ...
              var page = status.useStatusXY
                ...
                : utils.extend({}, modifiedCoords);
              var inner =
                rectUtils.xywhToTlbr(
                  getRestrictionRect(options.inner, interaction, page)
                ) || noInner;
              var outer =
                rectUtils.xywhToTlbr(
                  getRestrictionRect(options.outer, interaction, page)
                ) || noOuter;
        ...
        function (require, module, exports) {
          ...
          var restrictSize = {
            ...
            set: function set(arg) {
              ...
              var minSize =
                rectUtils.tlbrToXywh(
                  restrictEdges.getRestrictionRect(options.min, interaction)
                ) || noMin;
              var maxSize =
                rectUtils.tlbrToXywh(
                  restrictEdges.getRestrictionRect(options.max, interaction)
                ) || noMax;
        ...
        function (require, module, exports) {
          ...
          var snap = {
            ...
            setOffset: function setOffset(_ref) {
              ...
              var offsets = [];
              var optionsOrigin = utils.rectToXY(
                utils.resolveRectLike(options.origin)
              );
              var origin =
                optionsOrigin ||
                utils.getOriginXY(
              ...
              options =
                options ||
                interactable.options[interaction.prepared.name].snap ||
                {};
              ...
              if (options.offset === "startCoords") {
                ...
                var offsetRect = utils.resolveRectLike(
                  options.offset,
                  interactable,
                  element,
                  [interaction]
            ...
            set: function set(_ref4) {
              ...
              for (var _i2 = 0; _i2 < offsets.length; _i2++) {
                ...
                for (var _i3 = 0; _i3 < (options.targets || []).length; _i3++) {
                  ...
                  targets.push({
                    x: utils.is.number(target.x)
                      ? target.x + offsetX
                      : relativeX,
                    y: utils.is.number(target.y)
                      ? target.y + offsetY
                      : relativeY,

                    range: utils.is.number(target.range)
                      ? target.range
                      : options.range,
                  });
                }
              ...
              status.changed =
                snapChanged || (closest.inRange && !status.locked);
          ...
          interact.createSnapGrid = function (grid) {
            return function (x, y) {
              ...
              var newX = Math.max(
                limits.left,
                Math.min(limits.right, gridx * grid.x + offsetX)
              );
              var newY = Math.max(
                limits.top,
                Math.min(limits.bottom, gridy * grid.y + offsetY)
              );
      ...
      29: [
        function (require, module, exports) {
          ...
          module.exports = (function () {
            ...
            PointerEvent.prototype.subtractOrigin = function subtractOrigin(
              _ref
            ) {
              var originX = _ref.x,
                originY = _ref.y;
            ...
            PointerEvent.prototype.stopPropagation =
              function stopPropagation() {
                this.propagationStopped = true;
              };
            ...
            PointerEvent.prototype.stopImmediatePropagation =
              function stopImmediatePropagation() {
                this.immediatePropagationStopped =
                  this.propagationStopped = true;
              };
        ...
        function (require, module, exports) {
          ...
          function fire(arg) {
            var interaction = arg.interaction,
              ...
              _arg$type = arg.type,
              type =
                _arg$type === undefined ? arg.pointerEvent.type : _arg$type,
              _arg$targets = arg.targets,
              targets =
                _arg$targets === undefined
                  ? collectEventTargets(arg)
                  : _arg$targets,
              _arg$pointerEvent = arg.pointerEvent,
              pointerEvent =
                _arg$pointerEvent === undefined
                  ? new PointerEvent(
                      type,
                      pointer,
                      event,
          ...
          function collectEventTargets(_ref) {
            ...
            if (
              ...
              (interaction.pointerWasMoved ||
                ...
                !(
                  interaction.downTargets[pointerIndex] &&
                  interaction.downTargets[pointerIndex] === eventTarget
                ))
            ) {
              return [];
            }
          ...
          for (var i = 0; i < simpleSignals.length; i++) {
            Interaction.signals.on(
              simpleSignals[i],
              createSignalListener(simpleEvents[i])
            );
          }
        ...
        function (require, module, exports) {
          ...
          var browser = {
            ...
            supportsTouch: !!(
              ...
              (is.function(window.DocumentTouch) &&
            ...
            wheelEvent:
              "onmousewheel" in domObjects.document ? "mousewheel" : "wheel",
          };
          ...
          var domUtils = {
            ...
            indexOfDeepestElement: function indexOfDeepestElement(elements) {
              ...
              for (i = 1; i < elements.length; i++) {
                ...
                // an HTMLElement
                if (
                  deepestZone instanceof domObjects.HTMLElement &&
            ...
            getElementClientRect: function getElementClientRect(element) {
              var clientRect =
                element instanceof domObjects.SVGElement
          ...
          function add(element, type, listener, optionalArg) {
            ...
            if (!contains(target.events[type], listener)) {
              element.addEventListener(
                type,
                listener,
                supportsOptions ? options : !!options.capture
              );
      ...
      42: [
        function (require, module, exports) {
          ...
          module.exports = function (target, element, action) {
            ...
            var originRect = resolveRectLike(origin, target, element, [
              target && element,
            ]);
      ...
      44: [
        function (require, module, exports) {
          ...
          var utils = {
            ...
            getQuadraticCurvePoint: function getQuadraticCurvePoint(
              startX,
              startY,
              cpX,
              cpY,
            ...
            mouseOrPen: function mouseOrPen(_ref4) {
              ...
              for (var _i3 = 0; _i3 < scope.interactions.length; _i3++) {
                ...
                if (interaction.pointerType === pointerType) {
                  ...
                  if (
                    interaction.simulation &&
                    !utils.contains(interaction.pointerIds, pointerId)
                  ) {
                    continue;
                  }
        ...
        function (require, module, exports) {
          ...
          var pointerUtils = {
            ...
            setCoordDeltas: function setCoordDeltas(targetObj, prev, cur) {
              ...
              targetObj.page.speed =
                hypot(targetObj.page.x, targetObj.page.y) / dt;
              targetObj.page.vx = targetObj.page.x / dt;
              targetObj.page.vy = targetObj.page.y / dt;

              targetObj.client.speed =
                hypot(targetObj.client.x, targetObj.page.y) / dt;
            ...
            isNativePointer: function isNativePointer(pointer) {
              return (
                pointer instanceof dom.Event || pointer instanceof dom.Touch
              );
            },
            ...
            getPointerId: function getPointerId(pointer) {
              return is.number(pointer.pointerId)
                ? pointer.pointerId
                : pointer.identifier;
            },
            ...
            setCoords: function setCoords(targetObj, pointers, timeStamp) {
              ...
              targetObj.timeStamp = is.number(timeStamp)
                ? timeStamp
                : new Date().getTime();
            },
            ...
            getPointerType: function getPointerType(pointer) {
              return is.string(pointer.pointerType)
                ...
                /touch/.test(pointer.type) ||
                  pointer instanceof domObjects.Touch
                ? "touch"
                : "mouse";
            },
            ...
            getEventTargets: function getEventTargets(event) {
              var path = is.function(event.composedPath)
                ? event.composedPath()
                : event.path;
      ...
      51: [
        function (require, module, exports) {
          ...
          var rectUtils = {
            getStringOptionResult: function getStringOptionResult(
              value,
              interactable,
              element
            ) {
            ...
            resolveRectLike: function resolveRectLike(
              value,
              interactable,
              element,
              functionArgs
              ...
              value =
                rectUtils.getStringOptionResult(value, interactable, element) ||
                value;
